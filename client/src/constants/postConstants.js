...
export const POST_THELATEST_LIST_REQUEST = "POST_THELATEST_LIST_REQUEST";
export const POST_THELATEST_LIST_SUCCESS = "POST_THELATEST_LIST_SUCCESS";
export const POST_THELATEST_LIST_FAIL = "POST_THELATEST_LIST_FAIL";

export const POST_URGENT_LIST_REQUEST = "POST_URGENT_LIST_REQUEST";
export const POST_URGENT_LIST_SUCCESS = "POST_URGENT_LIST_SUCCESS";
export const POST_URGENT_LIST_FAIL = "POST_URGENT_LIST_FAIL";
...
export const POST_CATEGORIES_LIST_REQUEST = "POST_CATEGORIES_LIST_REQUEST";
export const POST_CATEGORIES_LIST_SUCCESS = "POST_CATEGORIES_LIST_SUCCESS";
export const POST_CATEGORIES_LIST_FAIL = "POST_CATEGORIES_LIST_FAIL";
